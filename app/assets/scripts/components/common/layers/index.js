...
const layerOverridesBySpotlight = {
  ...
  la: {
    ...
    'detection-ship': (l, spotlightId) =>
      handleInferenceTimeseries(l, spotlightId, {
        domain: ['2020-01-22', '2020-03-15', '2020-03-18', '2020-03-21', '2020-03-22', '2020-04-23', '2020-04-24', '2020-01-22', '2020-02-02', '2020-02-03', '2020-02-27', '2020-02-29', '2020-03-03', '2020-03-08', '2020-03-15', '2020-03-21', '2020-03-22', '2020-03-27', '2020-04-23', '2020-04-24']
      })
  },
  sf: {
    'nightlights-viirs': handleNightlightsViirs,
  ...
  ny: {
    ...
    'detection-ship': (l, spotlightId) =>
      handleInferenceTimeseries(l, spotlightId, {
        domain: ['2020-01-20', '2020-01-21', '2020-03-15', '2020-03-18', '2020-03-22', '2020-01-20', '2020-01-21', '2020-01-22', '2020-02-02', '2020-02-03', '2020-02-29', '2020-03-03', '2020-03-08', '2020-03-18', '2020-03-22']
      }),
    'water-spm': (l, spotlightId) => {
      return {
        ...l,
